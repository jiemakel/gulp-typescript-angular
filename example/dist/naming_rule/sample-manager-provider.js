...
(function (sample) {
    ...
    }());/*<auto_generate>*/angular.module('sample').provider('sampleManager',['$q',function(){return new (Function.prototype.bind.apply(SampleManagerProvider,[null].concat(arguments)));}]);/*</auto_generate>*/
